...
public class CNNAlgorithm extends AppCompatActivity {
    ...
    private void showStartDialog() {
        new AlertDialog.Builder(this)
            .setTitle("Attention!")
                .setMessage("Please Make Sure Your Camera is On focus and Try to capture only the skin area.")
    ...
    public void classifyImage(Bitmap image) {
        try{
            ...
            String[] classes = {"Acne and Rosacea "," Monkey Pox","Chiken Pox","Melanoma","Nevus"," Tinea Ringworm Candidiasis OR other Fungal Infect ","Vascular Tumors","Healthy Skin"};
