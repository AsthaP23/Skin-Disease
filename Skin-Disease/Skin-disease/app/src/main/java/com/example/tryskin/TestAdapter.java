...
public class TestAdapter {
    ...
    private com.example.tryskin.DatahelperActivity mDbHelper;

    public TestAdapter(Context context) {
        this.mContext = context;
        mDbHelper = new com.example.tryskin.DatahelperActivity(mContext);
...
/***********Insert User Query************/
    public long Insertuser(String sname, String semial,String saddress, String sphone, String spassword) {
        long i;
    ...
    public Cursor getMedicalid(String mobile) {
        String q = "Select * from User where Mobile='" + mobile + "'";
    ...
    public int checkUserLogin(String smobile, String spassword) {
        int i;
        String sql = "select count(*) from User where Mobile='" + smobile + "' and Password='" + spassword + "'";
        Cursor c = mDb.rawQuery(sql, null);
        //Log.w("Cursor", c.getString(0));
        c.moveToNext();
        i = Integer.parseInt(c.getString(0));
