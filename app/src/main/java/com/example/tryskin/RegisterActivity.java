...
public class RegisterActivity extends AppCompatActivity {
    ...
    Button register;
    TestAdapter adapter;
    String medicalid, semial, saddress, sphone, spassword;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(RegisterActivity.this, MyLoginActivity.class);
                startActivity(i);
            }
        });
        try {
    ...
    private void RegisterUser() {
        ...
        long i = adapter.Insertuser(medicalid, semial, saddress, sphone, spassword);
